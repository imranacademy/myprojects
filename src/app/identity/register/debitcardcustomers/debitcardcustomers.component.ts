...
@Component({
  selector: 'app-debitcardcustomers',
  templateUrl: './debitcardcustomers.component.html',
  styleUrls: ['./debitcardcustomers.component.css']
})
export class DebitcardcustomersComponent implements OnInit {
  ...
  get debitcard(){
    return this.form.controls['debitcard']
  }
  ...
  submit(){
    ...
    this.res$ =  this.http.registerUseDeditCard(this.form.value).pipe(
      catchError((er) => of(er))
     )
  }
